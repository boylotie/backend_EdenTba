...
class ContentController extends Controller
{
    ...
    /**
     * @return array{title: string, description: string|null, duration_seconds: int|null, speaker: string|null, speaker_id: int|null, year_id: int|null, month_id: int|null, week_id: int|null, special_activity_id: int|null, day_of_week: int|null, scheduled_at: string|null, sort_order: int}
     */
